...
class MACHINE_STATE(ctypes.Structure):
    __fields__ = [("reg_A", ctypes.c_uint64)]


class FixupMachine:
    machine_state = ld.symbols["_r_debug"]

    def __init__(self) -> None:
        self.rel_write = rel_write
        self.write = write

    def set_register_state():
        pass


call_fn(libc.symbols["__longjmp"])
